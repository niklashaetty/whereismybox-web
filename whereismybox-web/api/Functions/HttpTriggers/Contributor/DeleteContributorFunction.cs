...
public class DeleteContributorFunction
{
    ...
    public DeleteContributorFunction(IQueryHandler<GetUserPermissionsQuery, Permissions> permissionsQueryHandler,
        ICommandHandler<DeleteContributorCommand> commandHandler)
    {
    ...
    [OpenApiOperation(OperationId, new[] {"Contributors"},
        Summary = "Revoke access for another user to edit a collection")]
    ...
    public async Task<IActionResult> RunAsync(
        [HttpTrigger(AuthorizationLevel.Anonymous, "delete",
            Route = "collections/{collectionId}/contributors/{userId}")]
        HttpRequest req,
        string collectionId,
        Guid userId)
    {
